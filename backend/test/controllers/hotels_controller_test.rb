...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { meals: @hotel.meals, name: @hotel.name, pool: @hotel.pool, rating: @hotel.rating } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { meals: @hotel.meals, name: @hotel.name, pool: @hotel.pool, rating: @hotel.rating } }

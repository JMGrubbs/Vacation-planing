...
Location.create(name: "Orlando", description: "Orlando, Florida was once a small cattle town with no more than 200 inhabitants. Now it is the family entertainment capital of the world and this planet's most popular vacation spot. <br> <br> It would take several holidays to experience all that this fabulous place has to offer and there is literally something to suit every taste and age group. A hugely popular family holiday destination, this is Florida's entertainment capital, where the theme parks are unsurpassed by anything on earth.<br> <br> Almost everywhere you go in Orlando, reality takes a back seat and full-blown fantasy is there in its place. Nothing is quite what it seems. <br> <br> Not recommended for anyone looking for peace, quiet or restrained good taste, Orlando is ideal for thrill-seekers, and those who thrive on plenty of activity and entertainment. The area is extremely well catered for families and couples of all ages.")
Location.create(name: "Sydney", description: "Situated on the E coast, in the region of New South Wales, Sydney is Australia's oldest, largest and most diverse city. Located in the centre of Sydney is the dazzling Sydney Harbour with its iconic Sydney Harbour Bridge and Sydney Opera House. The city has no shortage of lazy bays and legendary surf beaches but Sydney is an adventure playground on the grandest scale with no shortage of activities. There's the Bondi surf, sailing under the Harbour Bridge on a yacht, jogging along the Coogee cliff tops or rampaging through Centennial Park on horseback. Everybody seems to enjoy the outdoors with swarming beaches, buzzing street cafés and the harbour is always blooming with a variety of sails. Sydney's location gives it a temperate, sunny climate with average maximum temperatures range from 17 degrees Celsius in winter (June-August) to 27 degrees Celsius in summer (December-February).<br> <br> Sydney's population is approaching five million, but it is easy to leave the frenetic urban pace behind with just a simple ferry ride to the North Shore for a bush walk, enjoy a stroll along the harbour beaches or take any one of a number of daytrips to explore the 'real' Australia on the doorstep. <br> <br> Sydney is a dynamic city and visitors love its verve and vibrancy, its beautiful harbour and myriad waterways. From sailboats and ferry rides to fine dining at a harbourside restaurant or outdoor cafe, the soul of Sydney is the harbour. The city is also a wonderful base for touring the New South Wales countryside and beyond the city there are friendly country towns, national parks filled with extraordinary flora and fauna, and beautiful beaches up and down the coast.")
Location.create(name: "London", description: "London is the capital of England, and has something to offer everyone - majestic stately houses, tranquil green parks and a zoo, engrossing museums and art galleries and bustling shopping centres with all the major stores, specialist shops and markets. <br> <br> The Royal Family have their main residence in London, at Buckingham Palace , but there are many other interesting houses to visit within London with Royal connections - Hampton Court Palace , The Tower of London , and Regents Park, an ancient Royal hunting park. <br> <br> London has a strong maritime tradition, and the docklands on the Thames are undergoing a transformation from empty warehouses to smart city offices and homes. You can learn all about London's Naval history at The National Maritime Museum in Greenwich, and aboard the Cutty Sark and HMS Belfast . Greenwich is also home to the Old Royal Observatory, which lies on the meridian line that divides the world into East and West, and where Greenwich Mean Time originates. <br> <br> The city is divided by the river Thames, which meanders through central London, splitting it into northern and southern halves. The central area and the most important sights, theatres and restaurants are within the Underground's Circle Line on the north bank of the river. <br> <br> The trendy and tourist-ridden West End lies within the western portion of the loop and includes Soho, Trafalgar Square, Piccadilly Circus, Leicester Square and Regent St. The East End, so beloved of Ealing comedies, lies east of the Circle Line; it used to be the exclusive preserve of the Cockney but is now a cultural melting pot.<br> <br> There are interesting 
...
Location.create(name: "Paris", description: "Paris, the cosmopolitan capital of France, has the reputation of being the most beautiful and romantic of all cities, brimming with historic associations and remaining vastly influential in the realms of culture, art, fashion, food and design. Dubbed the City of Light (la Ville Lumière) and Capital of Fashion, it is home to the world's finest and most luxorious fashion designers and cosmetics, such as Chanel, Christian Dior, Yves Saint-Laurent, Guerlain, Lancôme, L'Oréal, Clarins, etc. A large part of the city, including the River Seine, is a UNESCO World Heritage Site. The city has the second highest number of Michelin-restaurants in the world (after Tokyo) and contains numerous iconic landmarks, such as the world's most visited tourist sight the Eiffel Tower, the Arc de Triomphe, the Notre-Dame Cathedral, the Louvre Museum, Moulin Rouge, Lido etc, making it the most popular tourist destination in the world with 45 million tourists annually. <br> <br> It's hard to find words to do justice to Paris, although visitors and travel writers have certainly tried. The capital of France for 1,000 years, Paris is simply the city against which all others are measured. Sophisticated, stylish, romantic, gastronomic, cosmopolitan... the list goes on. <br> <br> The city's people are stylish and flirtatious, its architecture seductive, its restaurants and nightlife devoted to the pursuit of pleasure and its streets are scattered with dreams. <br> <br> The iconic views from the Eiffel Tower or Sacré Coeur reveal hundreds of attractions for the snap happy visitor, while mime artists and characteur painters dwell in the tourist crouds.")
Location.create(name: "Venice", description: "The historical centre of Venice is made up of six districts (sestiere): Cannaregio, Dorsoduro, Castello, Santa Croce, San Polo and San Marco. <br> <br> Divided in two by the Grand Canal, the districts of Cannaregio, Castello and San Marco occupy the northern part of the historical centre of Venice, while to the south of the Grand Canal we find the Santa Croce, San Polo and Dorsoduro districts. The Dorsoduro district also incorporates the Island of Guidecca Each of the six sestiere has its own unique character and specific attractions. <br> <br> Venice itself was built upon a series of islands, sand-banks and land reclaimed from the lagoon. Any sign of those original islands has long since been lost as the city continued to grow and develop as a sea of stone swept over her origins. <br> <br> But, not far from the historical centre of Venice , a string of Islands are waiting to be discovered by the intrepid traveller. Each one has its own particular attraction: <br> <br> There are two main means of transportation in Venice, pedestrian and waterborne. Waterborne transport consists of water taxis and waterbuses, or 'vaporetto'. <br> <br> There is a British diplomatic presence in Venice, and should you need assistance while in Italy, consular staff are on hand there to help travellers if they have a problem in the country. <br> <br> Italian is the official language. Dialects are spoken in different regions. German and Latin are spoken in the South Tyrol region, and French is spoken in all the border areas. German is spoken around the Austrian border. English, German and French are also spoken in tourism and business circles around Venice.
